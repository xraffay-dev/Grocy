...
class RecommendationSaver:
    ...
    def __init__(self, mongo_uri="mongodb://localhost:27017/", db_name="Grocy"):
        ...
        self.encoder = keras.models.load_model(
            "models/recommender_v5_encoder.keras", custom_objects=custom_objects
        )
        ...
        print("Model: V5 (99% accuracy, 2.83x category separation)\n")
    ...
    def generate_recommendations_for_all(self, top_k=10, max_price_ratio=1.5):
        ...
        for idx in tqdm(
            range(len(self.products_df)), desc="Generating recommendations"
        ):
        ...
        print(
            f"  Products with recommendations: {sum(1 for d in documents if d['total_recommendations'] > 0):,}"
        )
